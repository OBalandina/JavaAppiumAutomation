...
public class MainPageObject
{
  ...
  public   void swipeUpToFindElement(By by,String error_message,int max_swipes) //нужно элемента нет, прокручивает страницу вниз, до тех пор пка не достигнет футора
  {
...
//  driver.findElements(by).size();
  ...
  public int getAmoundOfElements(By by)
  {
