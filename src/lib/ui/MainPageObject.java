...
public class MainPageObject
{
  ...
  public   void swipeUpToFindElement(String locator,String error_message,int max_swipes) //нужно элемента нет, прокручивает страницу вниз, до тех пор пка не достигнет футора
  {
...
//  driver.findElements(by).size();
  ...
  public int getAmoundOfElements(String locator)
  {
    By by = this.getLocatorByString(locator);
  ...
  {
    int amount_of_elements = getAmoundOfElements(locator);
  ...
  private  By getLocatorByString(String locator_with_type)
  {
    ...
    String by_tupe = exploded_locator[0];
    String locator = exploded_locator[1];

    if (by_tupe.equals("xpath")) {
      return By.xpath(locator);
    }

    else if (by_tupe.equals("id")) {
